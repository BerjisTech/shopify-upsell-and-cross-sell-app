...
class Slade extends CI_Controller
{
    ...
    public function install()
    {
        ...
        $api_key = $this->config->item('shopify_api_key');
        $scopes = "read_orders,write_orders,read_draft_orders,read_products,read_product_listings,read_inventory,write_inventory,read_script_tags,write_script_tags,read_themes,write_themes,read_checkouts,write_checkouts,read_price_rules,write_price_rules,read_discounts,write_discounts,";
                        ...
                        foreach ($value['variants'] as $variant) {
                            $html .= '
                                        <div class="col-xs-12" style="padding-top: 5px; paddign-bottom: 5px;">
                                            <div class="col-xs-10">' . $value['title'] . '-' . $variant['title'] . '</div>
                                            <div class="col-xs-2">
                                                <span class="btn btn-info btn-xs entypo-plus" style="color: #fff;" onclick="products[$(\'.toplect\').val()][\'rp\']=' . $value['id'] . ';products[$(\'.toplect\').val()][\'rp\'] = ' . $variant['id'] . ';"></span>
                                            </div>
                                        </div>';
                        }
