...
class Slade extends CI_Controller
{
    ...
    public function activate()
    {
        ...
        if (isset($_GET['charge_id']) && $_GET['charge_id'] != '') {
            ...
            $this->Shopify->do_email($this->db->where('shop', $shop)->get('shops')->row()->shop_owner . ' just installed Sleek Apps on ' . $this->db->where('shop', $shop)->get('shops')->row()->domain, 'New User', 'sleek.apps.data@gmail.com', 'support@sleekupsell.com');
