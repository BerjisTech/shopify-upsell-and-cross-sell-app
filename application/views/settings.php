        ...
        <div class="setting_tab s_p" style="display: flex;">
            <div style="height: 100vh; background: #FAFAFA; padding: 10px;">
                ...
                <div class="input-group">
                    <input type="url" class="form-control frameUrl"/>
                    <span class="input-group-addon entypo-cw" onclick="$('.previewFrame').attr('src', $('.frameUrl').val());"></span>
                </div>
                
            </div>
            <div style="height: 100vh; margin: 0px; padding: 0px; text-align: center; flex-grow: 4;">
                <iframe is="x-frame-bypass" src="<?php echo 'https://'.$shop.'.myshopify.com'; ?>" align="middle" frameborder="0" class="previewFrame" id="previewFrame" width="100%" height="100%;"></iframe>
