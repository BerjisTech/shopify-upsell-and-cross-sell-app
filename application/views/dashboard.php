    ...
    <div class="mwili">
        <div style="width: 50px; height: 100vh; background: #981B1B; display: flex; flex-direction: column; justify-content: space-between; align-items: center; text-align: center;">
            <span class="whats">
                ...
                <a title="Setup Wizard" target="_BLANK" href="https://<?php echo $shop; ?>.myshopify.com?s<?php echo sha1($shop); ?>&t=<?php echo $_GET['hmac']; ?>"><span class="btn btn-primary entypo-feather"></span></a>
