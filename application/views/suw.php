...
<div class="btn btn-primary" onclick="window.history.back();" style="display: table; position: absolute; bottom: 10px; right: 10px; z-index: 2000000;"><span class="entypo-home"> BACK</span></div>
<div class="whole">
