...
<div class="dragger" style="cursor: grab; display: table; position: absolute; top: 10px; left: 10px; z-index: 2000000; color: #FFFFFF;"><span style="font-weight:700">ASSISTANT DE CONFIGURATION</span><br /><small>cliquez pour faire glisser</small></div>
<div class="btn btn-primary saver" style="display: table; position: absolute; top: 10px; right: 10px; z-index: 2000000;"><span class="entypo-floppy"> SAUVER</span></div>
<div class="btn btn-primary" onclick="removeWizard();" style="display: table; position: absolute; bottom: 10px; right: 10px; z-index: 2000000;"><span class="entypo-cancel"> FERMER</span></div>
<div class="whole">
    ...
    <div style="height: 400px; overflow-y: auto; flex-grow: 4; padding-bottom: 100px;">
        <div class="setting_tab s_p" style="display: flex;">
            <div style="height: 400px; background: #FAFAFA; padding: 10px;">
                ...
                <hr />
                <h4>Tester différentes mises en page</h4>
                    ...
                    <div class="panel panel-default cartP">
                        <div class="panel-heading">
                            <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion-test" href="#collapseOne" class="collapsed">
                                    Paramètres de la page du panier
                                </a> </h4>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <select type="text" name="cart_pos" class="form-control">
                                    <option value="prepend">Sommet de (Prepend)</option>
                                    <option value="before">Avant que (insertBefore)</option>
                                    <option value="append">Le fond de (Append)</option>
                    ...
                    <div class="panel panel-default drawerP">
                        <div class="panel-heading">
                            <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion-test" href="#collapseTwo" class="collapsed">
                                    Paramètres du tiroir du chariot
                                </a> </h4>
                        </div>
