...
let Sh_opify = Sh_opify || {};
// ---------------------------------------------------------------------------
// Money format handler
// ---------------------------------------------------------------------------
Sh_opify.money_format = g_s_s_w(burl + '/mf/' + Shopify.shop);
Sh_opify.currency = Sh_opify.money_format.substr(0, Sh_opify.money_format.indexOf('{')).substr(0, Sh_opify.money_format.indexOf('}'));
// console.log(Sh_opify.currency);
Sh_opify.formatMoney = function (cents, format) {
    ...
    function formatWithDelimiters(number, precision, thousands, decimal) {
        ...
        let parts = number.split('.'),
            dollars = parts[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, Sh_opify.currency + ' 1' + thousands),
...
async function sleek_upsell() {
    ...
    function display_offer(oid) {
        ...
        for (let i = 0; i < products.length; i++) {
            ...
            let o_ui = '<form class="sleek-form" data-product-index="' + i + '" data-product-product_id="' + pid + '"> <div class="sleek-image"> <img src="' + pDet.image['src'] + '"/> </div><div class="sleek-offer"> <div class="sleek-text">' + dtext + '</div><div class="sleek-title">' + pDet.title + '</div><div class="sleek-selectors"> <div class="offer_fields_holder o_h_' + pid + '"></div> <select name="id" class="v-select v-' + pid + '"></select> <select name="quantity" class="q-select q-' + pid + '"></select> </div></div><div class="sleek-card-atc"> <div class="sleek-prices"> <span class="sleek-price money">' + Sh_opify.formatMoney((pDet.variants[0]['price'] * 100), Sh_opify.money_format) + '</span> <span class="sleek-compare-price money">' + Sh_opify.formatMoney((pDet.variants[0]['compare_at_price'] * 100), Sh_opify.money_format) + '</span> </div><button class="sleek-atc" type="submit">' + atc + '</button> </div></form>';

            if (lay == 'card') {
                o_ui = '<form class="sleek-form" action="/cart/add" enctype="multipart/form-data" data-product-index="' + i + '" data-product-product_id="' + pid + '"> <div class="sleek-image"> <img src="' + pDet.image['src'] + '"/> </div><div class="sleek-offer"> <div class="sleek-text">' + dtext + '</div><div class="sleek-title">' + pDet.title + '</div><div class="sleek-selectors"> <div class="offer_fields_holder o_h_' + pid + '"></div> <select name="id" class="v-select v-' + pid + '"></select> <select name="quantity" class="q-select q-' + pid + '"></select> </div></div><div class="sleek-card-atc"> <div class="sleek-prices"> <span class="sleek-price money">' + Sh_opify.formatMoney((pDet.variants[0]['price'] * 100), Sh_opify.money_format) + '</span> <span class="sleek-compare-price money">' + Sh_opify.formatMoney((pDet.variants[0]['compare_at_price'] * 100), Sh_opify.money_format) + '</span> </div><button class="sleek-atc" type="submit">' + atc + '</button> </div></form>';
            } else if (lay == 'flat') {
                o_ui = '<form class="sleek-form" action="/cart/add" enctype="multipart/form-data" data-product-index="' + i + '" data-product-product_id="' + pid + '"> <div class="sleek-text">' + dtext + '</div><div class="sleek-flat"> <div class="sleek-image"> <img src="' + pDet.image['src'] + '"/> </div><div class="sleek-offer"> <div class="sleek-title">' + pDet.title + '</div><div class="sleek-prices"> <span class="sleek-price money">' + Sh_opify.formatMoney((pDet.variants[0]['price'] * 100), Sh_opify.money_format) + '</span> <span class="sleek-compare-price money">' + Sh_opify.formatMoney((pDet.variants[0]['compare_at_price'] * 100), Sh_opify.money_format) + '</span> </div><div class="sleek-selectors"> <div class="offer_fields_holder o_h_' + pid + '"></div> <select name="id" class="v-select v-' + pid + '"></select> <div class="flex-select"> <select name="quantity" class="q-select q-' + pid + '"></select> <button class="sleek-atc" type="submit">' + atc + '</button> </div></div></div></div></form>'
            } else if (lay == 'block') {
                o_ui = '<form class="sleek-form" action="/cart/add" enctype="multipart/form-data" data-product-index="' + i + '" data-product-product_id="' + pid + '"> <div class="sleek-text">' + dtext + '</div><div class="sleek-block"> <div class="sleek-image"> <img src="' + pDet.image['src'] + '"/> </div><div class="sleek-offer"> <div class="sleek-title">' + pDet.title + '</div><div class="sleek-prices"> <span class="sleek-price money">' + Sh_opify.formatMoney((pDet.variants[0]['price'] * 100), Sh_opify.money_format) + '</span> <span class="sleek-compare-price money">' + Sh_opify.formatMoney((pDet.variants[0]['compare_at_price'] * 100), Sh_opify.money_format) + '</span> </div><div class="sleek-selectors"> <div class="offer_fields_holder o_h_' + pid + '"></div> <select name="id" class="v-select v-' + pid + '"></select> <select name="quantity" class="q-select q-' + pid + '"></select> </div></div></div><button class="sleek-atc" type="submit">' + atc + '</button> </form>';
            } else if (lay == 'half-block') {
                o_ui = '<form class="sleek-form" action="/cart/add" enctype="multipart/form-data" data-product-index="' + i + '" data-product-product_id="' + pid + '"> <div class="sleek-half-block"> <div class="sleek-image"> <img src="' + pDet.image['src'] + '"/> </div><div class="sleek-offer"> <div class="sleek-text">' + dtext + '</div><div class="sleek-title">' + pDet.title + '</div><div class="sleek-prices"> <span class="sleek-price money">' + Sh_opify.formatMoney((pDet.variants[0]['price'] * 100), Sh_opify.money_format) + '</span> <span class="sleek-compare-price money">' + Sh_opify.formatMoney((pDet.variants[0]['compare_at_price'] * 100), Sh_opify.money_format) + '</span> </div><div class="sleek-selectors"> <div class="offer_fields_holder o_h_' + pid + '"></div> <select name="id" class="v-select v-' + pid + '"></select> <select name="quantity" class="q-select q-' + pid + '"></select> </div></div></div><button class="sleek-atc" type="submit">' + atc + '</button> </form>';
            } else if (lay == 'compact') {
                o_ui = '<form class="sleek-form" action="/cart/add" enctype="multipart/form-data" data-product-index="' + i + '" data-product-product_id="' + pid + '"> <div class="sleek-compact"> <div class="sleek-image"> <img src="' + pDet.image['src'] + '"/> </div><div class="sleek-offer"> <div class="sleek-text">' + dtext + '</div><div class="sleek-title">' + pDet.title + '</div><div class="sleek-prices"> <span class="sleek-price money">' + Sh_opify.formatMoney((pDet.variants[0]['price'] * 100), Sh_opify.money_format) + '</span> <span class="sleek-compare-price money">' + Sh_opify.formatMoney((pDet.variants[0]['compare_at_price'] * 100), Sh_opify.money_format) + '</span> </div><div class="sleek-selectors"> <div class="offer_fields_holder o_h_' + pid + '"></div> <select name="id" class="v-select v-' + pid + '"></select> <select name="quantity" class="q-select q-' + pid + '"></select> </div><button class="sleek-atc" type="submit">' + atc + '</button> </div></div></form>'
            }
                ...
                for (let vi = 0; vi < pDet.variants.length; vi++) {
                    ...
                    if (pDet.variants[vi]['inventory_quantity'] > 0) {
                        $('.v-' + pid).append('<option value="' + pDet.variants[vi]['id'] +
                            '">' + pDet.variants[vi]['title'] + ' (' + Sh_opify.formatMoney((pDet.variants[vi]['price'] * 100), Sh_opify.money_format) + ')</option>');
                    }
                }
            } else {
